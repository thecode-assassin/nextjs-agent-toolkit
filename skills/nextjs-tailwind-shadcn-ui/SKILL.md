---
name: nextjs-tailwind-shadcn-ui
description: Build and review Next.js App Router interfaces using installed Tailwind CSS and shadcn/ui conventions, including setup, tokens, themes, component composition, responsive design, forms, dialogs, accessibility, and server-client boundaries. Use only when Tailwind or shadcn/ui is installed or requested.
---
...
- installed Tailwind and shadcn versions, CSS entry points, aliases, tokens, theme variables, and component ownership
- semantic composition, variants, responsive states, dark mode, forms, dialogs, tables, and feedback
- minimal client islands, accessibility, hydration stability, and maintainable customization

## Decision Rules

- Inspect components.json and the existing design tokens before adding or changing components.
- Treat generated components as owned source: adapt them deliberately and preserve accessible primitives.
- Avoid arbitrary values and duplicated class strings when a token or reusable variant expresses the design.
